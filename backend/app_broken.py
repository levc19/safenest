...
def analyze_video_endpoint():
    ...
    try:
        ...
        try:
            # Extract frames from video - reduced to 5 frames max for speed
            frames_list = extract_frames(temp_video_path, sample_interval=2, max_frames=5)
            ...
            for frame_data in frames_list:
                ...
                # Skip expensive pose detection - use simple indicators instead
                fall_analysis = {'fall_detected': False}
                aggressive_analysis = {'aggressive_stance_probability': 0}
                rapid_motion = {'rapid_motion_detected': False, 'motion_intensity': motion_analysis.get('motion_intensity', 0)}
                fighting_analysis = {'fighting_probability': 0, 'contact_detected': False, 'contact_impact_intensity': 0}
